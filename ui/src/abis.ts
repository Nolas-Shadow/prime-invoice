export const primeInvoiceABI = [
    ...
    },
    {
        ...
        "inputs": [
            ...
            { "indexed": true, "internalType": "address", "name": "financier", "type": "address" },
            { "indexed": false, "internalType": "uint256", "name": "protocolFee", "type": "uint256" },
            { "indexed": false, "internalType": "uint256", "name": "financierYield", "type": "uint256" }
        ],
    ...
    },
    {
        "inputs": [
            ...
            { "internalType": "uint256", "name": "_termDays", "type": "uint256" }
        ],
        "name": "calculateFees",
        "outputs": [
            { "internalType": "uint256", "name": "protocolFee", "type": "uint256" },
            { "internalType": "uint256", "name": "financierYield", "type": "uint256" },
            { "internalType": "uint256", "name": "totalFee", "type": "uint256" },
            { "internalType": "uint256", "name": "supplierPayout", "type": "uint256" }
        ],
    ...
    },
    {
        ...
        "outputs": [
            ...
            { "internalType": "address", "name": "financier", "type": "address" },
